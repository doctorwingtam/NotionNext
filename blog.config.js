...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1fe2f30e71ba8019a44fd96e42912c7d,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DoctorSay', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'The doctor said, "A healthy body comes first, then a better life follows."', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://doctorsay.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'health,life,doctor,doctor say,healthy,keep fit', // 网站关键词 英文逗号隔开
